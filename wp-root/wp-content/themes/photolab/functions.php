...
function photolab_assets() {
	...
	wp_enqueue_style( 'photolab-layout', get_template_directory_uri() . '/css/layout.css', array(), '1.0.1' );
	wp_enqueue_style( 'photolab-magnific-popup', get_template_directory_uri() . '/css/magnific-popup.css', array(), '1.0.1' );
	wp_enqueue_style( 'dashicons' );
	wp_enqueue_style( 'photolab-fonts', photolab_fonts_url(), array(), null );
	wp_enqueue_style( 'photolab-style', get_stylesheet_uri(), array(), '1.0.1' );

	// layot CSS for old IE
	$wp_styles->add( 'photolab-layout-ie', get_template_directory_uri() . '/css/layout-ie.css', array(), '1.0.1' );
